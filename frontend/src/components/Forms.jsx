import { Box, Button, Container, Grid2, IconButton, Stack, TextField, Typography, Divider, FormLabel, FormControl, Link, Card, } from '@mui/material'
...
const LoginCard = styled(Card)(({ theme }) => ({
 ...
 const LoginForm = () =>{
    ...
    return(
        <Grid2 container sx={{ position: 'absolute', width: '100%', height: '100%', display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center' }}>
                        <Grid2 size={{ xs: 12, md: 4 }}>
                           
                            <LoginCard sx={{width:'100%', height:'auto'}}>
                                <Typography component={'h2'} variant='p' justifyContent={'center'} display={'flex'} alignItems={'center'} > <InsightsIcon /> Vizionary  </Typography>                              <Typography
                                    component="h4"
                                    variant="p"
                                    sx={{ width: '100%', }}
                                >
